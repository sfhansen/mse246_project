...
```{r}
var1yr = data.frame(
  -VaR(-one_year_default_result$Percentage, p=0.95)[1],
  -VaR(-one_year_default_result$Percentage, p=0.95)[1]*portfolio_nominal,
  -VaR(-one_year_default_result$Percentage, p=0.99)[1],
  -VaR(-one_year_default_result$Percentage, p=0.99)[1]*portfolio_nominal)

var5yr = data.frame(
  -VaR(-five_year_default_result$Percentage, p=0.95)[1],
  -VaR(-five_year_default_result$Percentage, p=0.95)[1]*portfolio_nominal,
  -VaR(-five_year_default_result$Percentage, p=0.99)[1],
  -VaR(-five_year_default_result$Percentage, p=0.99)[1]*portfolio_nominal)

-VaR(-one_year_default_result$Percentage, p=0.95)[1]
mean(one_year_default_result$Percentage)
```
...
- Fix total loss distribution, since it represents the *sum* of loss percentages - done
...
```{r}
ETL1yr = data.frame(
  -ETL(-one_year_default_result$Percentage, p=0.95)[1],
  -ETL(-one_year_default_result$Percentage, p=0.95)[1]*portfolio_nominal,
  -ETL(-one_year_default_result$Percentage, p=0.99)[1],
  -ETL(-one_year_default_result$Percentage, p=0.99)[1]*portfolio_nominal)

ETL5yr = data.frame(
  -ETL(-five_year_default_result$Percentage, p=0.95)[1],
  -ETL(-five_year_default_result$Percentage, p=0.95)[1]*portfolio_nominal,
  -ETL(-five_year_default_result$Percentage, p=0.99)[1],
  -ETL(-five_year_default_result$Percentage, p=0.99)[1]*portfolio_nominal)
