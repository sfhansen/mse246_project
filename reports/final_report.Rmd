...
The below figures show the out of sample performance of the one and five year ahead
probabilities estimated by the Cox model for active loans as of February, 1 2010. **Recall that at the beginning of the report we made note that all appended time series data variables were matched with our data at approval date. Thus, for example, the crime rate variable in a given feature vector is the crime rate at the time the loan was approveed.** This date was arbitrarily selected, but is the date at which we will construct the 500 loan portfolio in the following section:   
