...
ggplot(data = one_year_default_result, 
       aes(one_year_default_result$Percentage)) +
  scale_x_continuous(labels = scales::percent) + 
  scale_y_continuous(labels = scales::comma) + 
  geom_histogram(position = "identity") +
  labs(x = "Total Percentage Loss on Portfolio", y = "Count", 
...
from our bootstrap procedure. For each plot, we also add a visualisation of the VaR and AVaR
