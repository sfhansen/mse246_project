...
#dev.off()
```
![Tranche loss distribution for 1998](mse246_project/scripts/Tranche/DefaultDist/full_1998_tranche.png)
![Tranche loss distribution for 2003](mse246_project/scripts/Tranche/DefaultDist/full_2003_tranche.png)
![Tranche loss distribution for 2008](mse246_project/scripts/Tranche/DefaultDist/full_2008_tranche.png)


##Interpretations and Comparison of Distributions

See below table
![Distribution statistics from tranche losses by year](mse246_project/scripts/Tranche/DefaultDist/analysis_table.png)
